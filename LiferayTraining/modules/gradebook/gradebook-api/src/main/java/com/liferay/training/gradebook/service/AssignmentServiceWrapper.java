...
public class AssignmentServiceWrapper implements AssignmentService,
	...
	public java.util.List<com.liferay.training.gradebook.model.Assignment> getAssignmentsByKeywords(
		...
		return _assignmentService.getAssignmentsByKeywords(groupId, keywords,
			start, end, status, orderByComparator);
	}

	@Override
	public long getAssignmentsCountByKeywords(long groupId,
		java.lang.String keywords, int status) {
		return _assignmentService.getAssignmentsCountByKeywords(groupId,
			keywords, status);
	}
